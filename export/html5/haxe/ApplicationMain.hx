...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("AnimatedSprite", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("AnimatedSprite", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "AnimatedSprite";
		app.meta["name"] = "AnimatedSprite";
		...
		#elseif air
		app.window.title = "AnimatedSprite";
		#else
